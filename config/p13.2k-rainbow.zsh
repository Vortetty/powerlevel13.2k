# Config for Powerlevel13.2k with powerline prompt style with colorful background.
# Type `p13.2k configure` to generate your own config based on it.
#
...
() {
  ...
  function prompt_example() {
    p13.2k segment -b 1 -f 3 -i '⭐' -t 'hello, %n'
  }
